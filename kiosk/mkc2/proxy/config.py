...
PROXY_DATA = {
                "MOVIE_PROXY":{
                            ...
                            "SYNC_HOST":"movie.dvdnow.arcade.cab",
                            "SYNC_PORT":80
#                            "SYNC_HOST":"127.0.0.1",
#                             "SYNC_PORT":20380
                              },
                "CONN_PROXY":{
                            ...
                            "LOG_FORMAT":'%(asctime)s %(name)s %(levelname)s \t %(message)s',
                            "SYNC_HOST":"cnn.dvdnow.arcade.cab",
                            "SYNC_PORT":80
#                            "SYNC_HOST":"127.0.0.1",
#                            "SYNC_PORT":20080
                              },
                "UPG_PROXY":{
                            ...
                            "LOG_FORMAT":'%(asctime)s %(name)s %(levelname)s \t %(message)s',
                            "SYNC_HOST":"upg.dvdnow.arcade.cab",
                            "SYNC_PORT":80
#                            "SYNC_HOST":"127.0.0.1",
#                            "SYNC_PORT":20280                            
                              },
                "UMG_PROXY":{
                            ...
                            "LOG_FORMAT":'%(asctime)s %(name)s %(levelname)s \t %(message)s',
                            "SYNC_HOST":"umg.dvdnow.arcade.cab",
                            "SYNC_PORT":80
#                            "SYNC_HOST":"127.0.0.1",
#                            "SYNC_PORT":20580
                              },
                "UMS_PROXY":{
                            ...
                            "LOG_FORMAT":'%(asctime)s %(name)s %(levelname)s \t %(message)s',
                            "SYNC_HOST":"ums.dvdnow.arcade.cab",
                            "SYNC_PORT":80
#                            "SYNC_HOST":"127.0.0.1",
#                            "SYNC_PORT":20180
                              },
...
VIDEO_SERVER_HOST = "s250video.dvdnow.arcade.cab"
VIDEO_SERVER_USER = "s250"
VIDEO_SERVER_PASSWORD = "s250_video"
VIDEO_SERVER_PATH = "videos"

# Upg proxy.
UPG_AGENT_URL = "http://upg.dvdnow.arcade.cab/upg/agent/upgAgent"
...
UPG_NEED_APIS = ("getCcInfoByCcNumber", "check_black_list_for_chip_n_pin",
                 ...
                 "getCcInfoByCcId")
LITE_UPG_HOST = "upgs.dvdnow.arcade.cab"  #upgs.cereson.com
