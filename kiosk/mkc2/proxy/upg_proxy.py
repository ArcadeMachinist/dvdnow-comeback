...
class UPGProxy(Proxy):
    ...
    def preauthCard(self, customer, shoppingCart, zipcode = None, trsPasswd = None):
        ...
        """
        self.log.info('XXX preauthCard >>> 0 <<<')
        self._getTestMode()
        ...
        status = '4'
        self.log.info('XXX preauthCard >>> Z-C <<<')
        m = 'Sorry, the kiosk has communication issue.'
        self.log.info('XXX preauthCard >>> 1 <<<')
        try:
            ...
            self.log.info('XXX preauthCard >>> 2 <<<')
            rentAmount = 0
            saleAmount = 0
            shoppingCart.totalCharged = 0
            ...
            self.log.info('XXX preauthCard >>> 6 <<<')
            for disc in shoppingCart.discs:
            ...
            if usedMonthSubs == 3:
                ...
                self.log.info('XXX preauthCard >>> 9 <<<')
            ...
            self.log.info('XXX preauthCard >>> A <<<')
            cartStr = 'Preauth for Shopping Cart: Status: %s; ID: %s; totalCharged: %s; coupon code: %s \nDISCS: \n%s'
#            discStr = ('\n\n'.join,)((lambda .0: for disc in .0:
#'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s,\n msExpiTime: %s' % (str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title), str(disc.salePrice), str(disc.preauthAmount), str(disc.reserveID), str(disc.coupon.couponCode), str(disc.gene), str(disc.outKioskID), str(disc.rentalTax), str(disc.saleTax), str(disc.pricePlanID), str(disc.upgID), disc.msExpiTime))(shoppingCart.discs))
            discStr = '\n\n'.join(
                'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s,\n msExpiTime: %s' 
                % (
                    str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title), 
                    str(disc.salePrice), str(disc.preauthAmount), str(disc.reserveID), 
                    str(disc.coupon.couponCode), str(disc.gene), str(disc.outKioskID), 
                    str(disc.rentalTax), str(disc.saleTax), str(disc.pricePlanID),
                    str(disc.upgID), str(disc.msExpiTime)
                )
                for disc in shoppingCart.discs
            )        
            self.log.info('XXX preauthCard >>> B <<<')
            ...
            status = '4'
            self.log.info('XXX preauthCard >>> Z-D <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except RemoteError:
            ex = None
            ...
            self.log.error(errMsg)
            status = '4'
            self.log.info('XXX preauthCard >>> Z1 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except Exception:
            ex = None
            ...
            self.log.error(errMsg)
            status = '4'
            self.log.info('XXX preauthCard >>> Z2 <<<')
            m = 'Sorry, the kiosk has communication issue.'
    ...
    def getResForSA(self, customer, shoppingCart, seq, trsIdty):
        ...
        try:
            ...
            if para:
               ...
               # discStr = ('\n\n'.join,)((lambda .0: for disc in .0:
               # 'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n pricePlan: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s' % (str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title), str(disc.salePrice), str(disc.preauthAmount), str(disc.reserveID), str(disc.coupon.couponCode), str(disc.gene), str(disc.outKioskID), str(disc.pricePlan), str(disc.rentalTax), str(disc.saleTax), str(disc.pricePlanID), str(disc.upgID)))(shoppingCart.discs))
                discStr = '\n\n'.join(
                    'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s,\n msExpiTime: %s'
                    % (
                        str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title),
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z3 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except RemoteError:
            ex = None
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z4 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except Exception:
            ex = None
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z5 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except Exception:
            ex = None
            errMsg = '[Local] Error occurs when sendReqForSA: %s' % ex
    ...
    def charge_sitef(self, customer, acctId, amount):
        ...
        if result.get('status', '') == 0:
            ...
            customer.cardType = 4
            self.log.info('XXX charge_sitef >>> 6 <<<')
    ...
    def chargeForSiTef(self, customer, shoppingCart):
        self.log.info('chargeForSiTef  >>> 0 <<<')
        self._getTestMode()
        if self.UPG_SHOW_MODE:
            shoppingCart.totalCharged = 0
            for disc in shoppingCart.discs:
        ...
        try:
            ...
            if acctId:
                ...
                # discStr = ('\n\n'.join,)((lambda .0: for disc in .0:
# 'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s' % (str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title), str(disc.salePrice), str(disc.preauthAmount), str(disc.reserveID), str(disc.coupon.couponCode), str(disc.gene), str(disc.outKioskID), str(disc.rentalTax), str(disc.saleTax), str(disc.pricePlanID), str(disc.upgID)))(shoppingCart.discs))
                discStr = '\n\n'.join(
                    'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s,\n msExpiTime: %s' 
                    % (
                        str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title),
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z6 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except socket.error:
            ex = None
            ...
            self.log.error(errMsg)
            status = '10'
            self.log.info('XXX preauthCard >>> Z7 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except RemoteError:
            ex = None
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z8 <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except Exception:
            ex = None
            errMsg = '[Local] chargeForSiTef (%s): %s' % (customer.ccid, traceback.format_exc())
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z9 <<<')
            m = 'Sorry, the kiosk has communication issue.'
    ...
    def chargeForChipNPin(self, customer, shoppingCart):
        ...
        """
        self.log.info('chargeForChipNPin  >>> 0 <<<')
        self._getTestMode()
        if self.UPG_SHOW_MODE:
            shoppingCart.totalCharged = 0
            for disc in shoppingCart.discs:
...
#'rfid: %s;\n upc: %s;\n slotID: %s;\n title: %s;\n salePrice: %s;\n preauthAmount: %s;\n reserveID: %s;\n coupon code: %s;\n gene: %s;\n outKioskID: %s;\n rentalTax: %s;\n saleTax: %s;\n pricePlanID: %s,\n upgID: %s' % (str(disc.rfid), str(disc.upc), str(disc.slotID), str(disc.title), str(disc.salePrice), str(disc.preauthAmount), str(disc.reserveID), str(disc.coupon.couponCode), str(disc.gene), str(disc.outKioskID), str(disc.rentalTax), str(disc.saleTax), str(disc.pricePlanID), str(disc.upgID)))(shoppingCart.discs))
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z-A <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except socket.error:
            ex = None
            ...
            self.log.error(errMsg)
            status = '10'
            self.log.info('XXX preauthCard >>> Z-E <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except RemoteError:
            ex = None
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z-F <<<')
            m = 'Sorry, the kiosk has communication issue.'
        except Exception:
            ex = None
            ...
            self.log.error(errMsg)
            status = '9'
            self.log.info('XXX preauthCard >>> Z-G <<<')
            m = 'Sorry, the kiosk has communication issue.'
    ...
    def charge_chip_n_pin(self, customer, acctId, amount):
        ...
        Charge the amount for chip n pin.
        '''
        self.log.info('charge_chip_n_pin  >>> 0 <<<')
        status = '1'
        m = ''
        (server, port, baseUrl) = self._getUpgServerFromUrl(self._getConfigByKey('upg_url'))
    ...
    def getRemoteData(self, funcName, params, timeout = 60):
        ...
        '''
        self.log.info('XXX getRemoteData >>> 0 <<<')
        if funcName in UPG_NEED_APIS:
            url = 'http://%s/api' % LITE_UPG_HOST
            url_params = {
                'function_name': funcName,
                'params': params }
            self.log.info('XXX getRemoteData >>> 1 <<<')
            return self._http_call(url, url_params, timeout)
        else:
            self.log.info('XXX getRemoteData >>> 2 <<<')
    ...
    def check_monthly_subscription(self, customer, shopping_cart):
        ...
        @return: status, ms_expi_time, invalid_disc_type, rent_count
                ...
                rent_count(int)
        '''
        self.log.info('check_monthly_subscription  >>> 0 <<<')
        status = -1
        ms_expi_time = ''
        invalid_disc_type = set()
        rent_count = 0
    ...
    def preauth(self, acctId, customer, amount, zipcode = None, trsPasswd = None, oid = '', peauthMethod = 'full'):
        ...
        try:
            ...
            if pqInfo and pqInfo.get('upg_id', None):
                ...
                self.log.info('preauth  >>> 6 <<<')
                if str(tmp[0]) in ('-1', '-2'):
                    raise Exception(tmp[1])
                self.log.info('preauth  >>> 7 <<<')
                params['oid'] = tmp[2]
    ...
    def getCCInfoByCustomer(self, customer):
        ...
        '''
        status = 1
        self.log.info('XXX _getCcInfoByCustomer >>> 0 <<<')  
        try:
            self._getTestMode()
            if self.UPG_SHOW_MODE:
                return 0
            ...
            status = 0
            self.log.info('XXX _getCcInfoByCustomer >>> 1 <<<')
            if customer:
                self.log.info('XXX _getCcInfoByCustomer >>> ccMum <<<' + str(customer.ccNum))
                self.log.info('XXX _getCcInfoByCustomer >>> 2 <<<')
                if customer.ccNum or customer.track2:
                    self.log.info('XXX _getCcInfoByCustomer >>> 3 <<<')
                    ...
                    self.log.info('XXX _getCcInfoByCustomer >>> 4 <<<')
                    customer.ccid = result['cc_id']
                    self.log.info('XXX _getCcInfoByCustomer >>> 5 <<<')
                    customer.isNew = result['is_new']
                    self.log.info('XXX _getCcInfoByCustomer >>> 6 <<<')
                    customer.cardType = result['cc_type']
                    self.log.info('XXX _getCcInfoByCustomer >>> 7 <<<')
                    customer.ccDisplay = result['cc_display']
                    self.log.info('XXX _getCcInfoByCustomer >>> 8 <<<')
                    customer.ccName = result['cc_name']
                    self.log.info('XXX _getCcInfoByCustomer >>> 9 <<<')
                    customer.ccExpDate = result['cc_expdate']
                    self.log.info('XXX _getCcInfoByCustomer >>> A <<<')
                    customer.track2 = result['cc_track2']
                    self.log.info('XXX _getCcInfoByCustomer >>> B <<<')
                    customer.track1 = result['cc_track1']
                    self.log.info('XXX _getCcInfoByCustomer >>> C <<<')
                    self._saveLocalCC(result)
                    self.log.info('XXX _getCcInfoByCustomer >>> D <<<')
                else:
                    status = 1
        except RemoteError:
            ex = None
...
#        $append0 = [].append
#        del $append0
#        sql = [] % []([ str(trsId) for trsId in trsList ])
        sql = "SELECT trs_id, shopping_cart_id FROM transactions WHERE trs_id IN (%s)" % ','.join(str(trsId) for trsId in trsList)
        rows = self.mkcDb.query(sql)
        for trsId, shoppingCartId in rows:
            if shoppingCartId not in result:
...
class PostauthQueue(object):
    ...
    def getOtherTrsIsByUpgId(self, upgId, trsIds):
        ''' '''
#        trsIdsStr = '(%s)' % (','.join,)((lambda .0: for trsId in .0:'%s' % str(trsId))(trsIds))
